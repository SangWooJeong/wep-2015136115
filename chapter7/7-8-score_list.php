<?
    $connect = mysql_connect("localhost","jsw","1234"); // DB 연결
    mysql_select_db("jsw_db", $connect);                // DB 선택
    ...
    if ($_GET[mode] == "insert")                       	   // 데이터 입력 모드
    {
        ...
        $sql .= "('$_POST[name]', $_POST[sub1], $_POST[sub2], $_POST[sub3], $_POST[sub4], $_POST[sub4], $_POST[sum], $_POST[avg])";
