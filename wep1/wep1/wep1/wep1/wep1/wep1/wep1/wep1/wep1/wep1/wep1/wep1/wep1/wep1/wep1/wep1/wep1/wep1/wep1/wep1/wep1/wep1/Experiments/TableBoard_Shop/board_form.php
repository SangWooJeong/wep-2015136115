...
if(isset($_GET[num])) {
    ...
    $sql2 = "select * from tableboard_shop like $num";
...
for($i=0;i<$_POST[num];$i++){
    $row = mysql_fetch_array($result);
                                    ...
                                    echo '<td class="column1"><input name="date" type="text" value= '; echo $row[1];   echo '     />  </td>';
                                    echo '<td class="column2"><input name="order_id" type="number" value=';echo $row[2] ;echo '   /> </td>';
                                    echo '<td class="column3"><input name="name" type="text" value= '; echo $row[3];echo '   /> </td>';
                                    echo '<td class="column4"> <input name="price" type="number" placeholder="$" style="text-align: right;" value=';echo $row[4]; echo '  /></td>';
                                    echo '<td class="column5"><input name="quantity" type="number"style="text-align: right;" value= ';echo $row[4]; echo'/></td>';
                                    echo '<td class="column6">$<span id="total">'; echo $row[4]*$row[5]; echo '</span> </td>';
