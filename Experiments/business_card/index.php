...
<div class="container">
    <div class="card card--front">
        ...
        <div class="text">
            <header class="head">
                <h1 class="head__name">
                    <b class="name__fn"><?php echo $_POST[name]; ?></b>
                    Pickering
                </h1>
                <p class="head__subtitle">Front-end Web<br> <?php echo $_GET[job];?></p>
            </header>
        </div>
    </div>
    ...
    <div class="card card--back">
        <div class="card__content">
            <ul class="contact">
                ...
                <li><a href="https://keithpickering.github.io"><?php echo $_POST[name]; ?></a></li>
                <li><a href="https://facebook.com/keithpickeringdesign">hi</a></li>
